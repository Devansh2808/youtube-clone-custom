/**
 * Displays channel information and a subscribe/unsubscribe button.
 *
 * @component
 * @param {Object} props
 * @param {Object} props.video - The video object containing channel and uploader info.
 * @param {Object} props.currentChannel - The current channel object with subscriber data.
 * @param {boolean} props.isSubscribed - Indicates if the user is subscribed to the channel.
 * @param {Function} props.onSubscribeToggle - Callback function to handle subscribe/unsubscribe action.
 * @returns {JSX.Element} The rendered ChannelInfo component.
 */
