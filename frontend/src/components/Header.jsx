 ...
 *
 * This component renders the top navigation bar, including:
 * - Hamburger menu to toggle the sidebar.
 * - Application logo linking to the home page.
 * - Search bar (visible only on the home page and on larger screens).
 * - Authentication controls (Login/Logout).
 * - User profile display (profile picture and username).
 * - Channel management buttons ("My Channel" or "Create Channel" depending on user state).
 *
 * Integrates with Redux for authentication, search term, and UI state management.
 * Uses React Router for navigation and location awareness.
 * Displays toast notifications on logout.
 *
 * @component
 * @example
 * return (
