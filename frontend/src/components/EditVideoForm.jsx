/**
 * EditVideoForm component allows users to edit video details such as title, description, category,
 * thumbnail, and video file. It displays a form pre-filled with the current video data and handles
 * form submission with validation and file uploads.
 *
 * @file EditVideoForm.jsx
 * @module components/EditVideoForm
 * @author [Your Name]
 * 
 * @requires react
 ...
 * @param {Object} props.video - The video object containing current video details
 * @param {Function} props.onSubmit - Callback function to handle form submission, receives FormData
 * @param {boolean} props.videoUpdating - Indicates if the video is currently being updated
 *
 * @returns {JSX.Element} The EditVideoForm component
 */
