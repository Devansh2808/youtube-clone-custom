/**
 * Sidebar component for the YouTube clone application.
 *
 * Renders a collapsible sidebar with navigation links grouped into three sections:
 * - Home: Main navigation links (Home, Shorts, Subscriptions).
 * - You: User-specific links (History, Playlists, Watch later, Liked videos).
 * - Explore: Additional categories (Trending, Shopping, Music, Movies, Live, Gaming, News, Sports).
 *
 * The sidebar's visibility is controlled by the `isSidebarOpen` state from Redux.
 * Uses react-icons for icons and react-router-dom's Link for navigation.
 *
 * @component
